...
已经确认的实施基线将默认短码长度设为 6 位，并支持配置为 6、7、8 位。当前不会把默认值静默改成 7 位。

如果采用 7 位，Base62 的理论空间是 `62^7`，约为 3.5 万亿，能够显著降低高规模场景下的碰撞概率。因此 7 位是更适合生产规模的可选配置；6 位则便于当前笔试项目演示和保持既有兼容性。
